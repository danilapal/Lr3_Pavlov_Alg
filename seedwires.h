...
#include <math.h>
template <class T>
T countS (std::vector<std::vector<T>> distance,std::vector<std::vector<T>> wires,std::vector<T> place) {
...
template <class T>
void  spaceComponentsT(T variant,T free,T choose,std::vector<std::vector<T>> distance,std::vector<std::vector<T>> wires,std::vector<T> options,std::vector<T> place,T &bestS)
{
...
template <class T>
void  spaceComponents(std::vector<std::vector<T>> distance,std::vector<std::vector<T>> wires,std::vector<T> options,std::vector<T> place,T &bestS)
{
